"""
    agent.py:
        Основной скрипт для построение графа Мультиагентной системы.
    TODO:
        1.Обернуть построение графа в class чтобы было удобно использовать его
        2.Убрать состояние в отдельный модуль чтобы было легче масштабировать
        3.Убрать роутера в отлельный модуль чтобы было легче масштабировать
        4.Нарисовать граф
"""
